...
public class FirstPersonAIO : MonoBehaviour {
    ...
    #region Recording Points
    public static Vector3 LIVINGROOM = new Vector3(-0.415f, 1f, 0.547f);
    public static Vector3 KITCHEN = new Vector3(0.983f, 1f, 1.395f);
    public static Vector3 GUESTROOM = new Vector3(1.091f, 1f, -0.226f);
    public static Vector3 BEDROOM1 = new Vector3(-1.476f, 1f, 0.845f);
    public static Vector3 BEDROOM2 = new Vector3(-0.19f, 1f, -0.877f);
    public static Vector3 BATHROOM1 = new Vector3(2.92625f, 1f, -1.05f);
    public static Vector3 BATHROOM2 = new Vector3(0.156f, 1f, 0.668f);
    public static Vector3[] RECORDINGPOINTS = {LIVINGROOM, KITCHEN, GUESTROOM, BEDROOM1, BEDROOM2, BATHROOM1, BATHROOM2};
    public int idx = 0;
    public int ctr = 0;
    public Vector3 vel = Vector3.zero;
    public static int FRAMES_PER_POINT = 30;
    #endregion
    ...
    private void Update()
    {
        ...
        // prob just apply random rotations to the camera and remove the mouse input code
        if (idx == RECORDINGPOINTS.Length)
        {
            UnityEditor.EditorApplication.isPlaying = false;
        }
        if (ctr == FRAMES_PER_POINT) {
            playerCamera.transform.position = RECORDINGPOINTS[idx++];
            ctr = 0;
        }
        ctr++;
        vel = new Vector3(Random.Range(-5f, 5f), 0, Random.Range(-5f, 5f));
        //vel.Normalize();
        Vector3 rot = new Vector3(Random.Range(-20f, 20f), Random.Range(0f, 360f), 0f);

        playerCamera.transform.rotation = Quaternion.Euler(rot.x, rot.y, rot.z);
